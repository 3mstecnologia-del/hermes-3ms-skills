...
| [`mikrotik-routeros-ops`](.hermes/skills/3mstecnologia/mikrotik-routeros-ops/SKILL.md) | 0.2.0 | DEV | MikroTik RouterOS 6/7 |
| [`network-device-cli-capture`](.hermes/skills/3mstecnologia/network-device-cli-capture/SKILL.md) | 1.1.0 | DEV | Captura segura de CLIs legadas |
