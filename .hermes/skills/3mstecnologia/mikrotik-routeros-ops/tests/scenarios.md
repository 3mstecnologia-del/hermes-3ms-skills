...
**Esperado:** Ler a pós-condição completa. Se já está correta: `already-satisfied` (`executed=false`), não `applied`. Se a identidade existe com atributos divergentes: `mismatch` e parar — não adicionar de novo.
